...
var MYAPP  = MYAPP || {
    ...
    initializeGame: function() {
        ...
        $('.game-choice button').click(function() {
            ...
            $('.game-stater .choice-x,.game-stater .choose-o').off().click
    ...
    showGameStarter: function(isTwoPlayer){
        ...
        drawBoard: function() {
            MYAPP.timeOuts.push(setTimeout(function() {
                ...
                var canvas = c.getElementById("myCanvas");
                canvas.lineWidth = 1;
...
MYAPP.game = {
    ...
    firstGame: function() {
        ...
        MYAPP.playerOneSymbol = MYAPP.playerOneSymbol == 'X' ? 'O' : 'X';
    ...
    playerTurn: function(square) {
        var symbol = MYAPP.turn === 1 ? MYAPP.playerOneSymbol :
        MYAPP.playerTwoSymbol;
        ...
        if(MYAPP.gameInPlay) {
            if(MYAPP.game.checkWin(symbol)[0]) {
                ...
                if(MYAPP.secondPlayer) {
                    ...
                    MYAPP.turn === 1 ? MYAPP.display.showWinMessage() :
    ...
    showWinningCombination: function() {
        ...
        for(var i= 0; i < combo.length; i++) {
            ...
            $(currentBox).children('i').addClass('win').children('span')
            .addClass('rotate');
        }
    },
    pdateScore: function(turn) {
        turn === 1 ? MYAPP.playerOneScore += 1 :
        MYAPP.playerTwoScore += 1;
...
MYAPP.computer = {
    computerWhichMove : function () {
        ...
        move = (move && MYAPP.currentBoard[move]) === '' ? move :
        false;
        return move;
    },
    ...
    doubleThreatChoice: function (choiceType) {
        ...
        {
            if((board[1] === opponentSymbol && board[9] === 
                opponentSymbol)|| (board[3] === opponentSymbol && board[7]
                    === opponentSymbol)) {
